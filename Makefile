...
#
drupal_version=7.67
# needs to be congruent with drupal version in name of file '/obiba-home-master/drupal/drupal-7.67.sql'
# in https://github.com/obiba/obiba-home/archive/master.tar.gz
...
enable-modules-snapshot: enable-bootstrap enable-mica enable-data-access enable-research-project enable-graphics enable-sets enable-analysis update-composer-autoload jquery_update
...
# Enable obiba_mica using 'module_enable' instead of 'drush en'
# (to avoid the 'One or more extensions have dependencies managed by Composer. Update packages managed by Composer?' question)
# 'module_enable' silently enables the module and all its dependencies (below) without updating anything
enable-mica:
	cd $(drupal_dir) && \
	drush eval 'module_enable(array("obiba_mica"))'
# Enabled dependencies:
# 	- modules: jquery_update libraries variable locale i18n http_client entity countries collapsiblock composer_manager
#		- extensions: obiba_mica_app_angular obiba_mica_commons obiba_mica_dashboard obiba_mica_dataset obiba_mica_files obiba_mica_graphic obiba_mica_lists obiba_mica_network obiba_mica_persons obiba_mica_repository obiba_mica_study
